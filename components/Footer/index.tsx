            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="https://www.google.com/search?hl=en-MA&gl=ma&q=3%C2%B0+%C3%A9tage,+FENIFAB,+Rue+Mostapha+El+Maani+,+angle.+11+Janvier,+r%C3%A9sidence+Prima,+Casablanca+20610&ludocid=13623682206235383504&lsig=AB86z5Wt2wnFqBXWjlP-7UhtIc0x#lrd=0xda7cdcdd048f5cb:0xbd110ac9037856d0,3"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                      {" "}
                      Rediger un avis{" "}
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Site crèes par <a href="https://www.linkedin.com/in/houssam-machmech/" rel="nofollow noopener">Houssam machmech</a>
            </p>
          </div>
        </div>
